class DiplomaAutoclicker {
    ...
    showDiplomaNotification() {
        ...
        showNotification('🎓 Диплом ' + (this.currentDiploma - 1) + ' готов!<br>Начинаем: ' + diploma.name + '<br>Цель: ' + diploma.pages + ' страниц');
    }
    ...
    checkModeUnlocks() {
        ...
        if (this.totalClicks >= 1000 && btnNormal.disabled) {
            ...
            showNotification('🔓 Нормальный режим открыт! (1000 кликов)');
        }
        ...
        if (this.totalClicks >= 10000 && btnPanic.disabled) {
            ...
            showNotification('🔓 РЕЖИМ ПАНИКИ ОТКРЫТ! (10000 кликов)');
        }
    }
